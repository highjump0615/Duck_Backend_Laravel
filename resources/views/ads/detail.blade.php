...
@section('content')
    ...
    <section class="Hui-article-box" style="overflow: auto;">
        <nav class="breadcrumb">
            <i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 宣传管理 <span class="c-gray en">&gt;</span> 宣传详细
        ...
        <div class="page-container">
            <form action="" method="post" class="form form-horizontal" id="form-article-add">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <select class="select">
                            <option value="10">商品1</option>
                            <option value="25">商品2</option>
                            <option value="50">商品3</option>
                        </select>
                    </div>
                </div>
                <div class="row cl">
